...
public class GunControllerHandLeft : MonoBehaviour //todos os leftClicks tem o controle da arma (armas left, cores right)
{
    //public
    ...
    void Fire() //atirar
    {
        ...
        if (bulletH != null) //se conseguiu
        {
            ...
            bulletH.isBurningBullet = true; //informar que congela/ou queima (isFreeezingBullet/isBurningBullet)
        }
